"""
Testbench UI - Navigation Skeleton
...
Tolerances shown on-screen:
  Ohmmeter          +/- 5% of reading
  Voltmeter         +/- 0.1 V
  DC Reference      +/- 0.05 V
  Freq Measure      +/- 1% of reading
  Square amplitude  +/- 0.1 V
  Sine amplitude    +/- 0.1 V
"""
...
OHM_TOL_FRACTION  = 0.05    # +/- 5% of reading
VOLT_TOL_V        = 0.1     # +/- 0.1 V on voltmeter
DC_TOL_V          = 0.05    # +/- 0.05 V on DC reference
FREQ_TOL_FRACTION = 0.01    # +/- 1% on frequency meter
SQUARE_AMP_TOL_V  = 0.1     # +/- 0.1 V on square-wave amplitude
SINE_AMP_TOL_V    = 0.1     # +/- 0.1 V on sine-wave amplitude
